                ...
                if len(intersected_points) > 0:
                    for intersected_points_iter in intersected_points:
                        ...
                        for i in range(len(inner)):
                            if (
                                croped_line.intersects(inner[i])
                                and croped_line.intersection(inner[i]).geom_type
                                == "LineString"
                            ):
                                # print('Protina jednou primkou')
                                intersected = True
                                intersection = list(
                                    croped_line.intersection(inner[i]).coords
                                )
                        ...
                        if intersected:
                            ...
                            for lin in splitted.geoms:
                                ...
                                for i in range(len(inner)):
                                    ...
                                    if lin.intersects(inner[i]) and (
                                        (lin.intersection(inner[i])).geom_type
                                        == "LineString"
                                        or "MultiLineString"
                                    ):
